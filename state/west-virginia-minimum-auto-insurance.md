---
title: West Virginia Minimum Auto Insurance Requirements (2025)
description: Summary of West Virginia's minimum auto insurance liability requirements with links to ru3.us structured datasets.
layout: default
---
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "West Virginia Minimum Auto Insurance Requirements",
  "description": "Minimum auto liability insurance requirements for West Virginia, including bodily injury per person, bodily injury per accident, and property damage per accident, derived from the ru3.us Minimum Liability Dataset Version 2025.01.",
  "url": "https://ru3.us/state/west-virginia-minimum-auto-insurance",
  "creator": {
    "@type": "Organization",
    "name": "ru3.us"
  },
...
# West Virginia Minimum Auto Insurance Requirements (2025)

This page summarizes **state minimum auto liability requirements** for **West Virginia** as recorded in the **ru3.us Minimum Auto Liability Dataset (Version 2025.01)**.
...
## Minimum Required Liability Coverage in West Virginia

The following limits are recorded for West Virginia in the ru3.us liability dataset:
...
## UM/UIM and PIP in West Virginia
...
In **Dataset Version 2025.01**, if the original reference did **not** explicitly describe a mandatory UM/UIM or PIP requirement for West Virginia, those fields are conservatively marked as `"unknown"` rather than assumed.

To review how West Virginia is represented:
