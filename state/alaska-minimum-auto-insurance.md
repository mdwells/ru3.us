---
title: Alaska Minimum Auto Insurance Requirements (2025)
description: Summary of Alaska's minimum auto insurance liability requirements with links to ru3.us structured datasets.
layout: default
---
...
## Minimum Required Liability Coverage in Alaska

The following limits are recorded for Alaska in the ru3.us liability dataset:
...
In **Dataset Version 2025.01**, if the original reference did **not** explicitly describe a mandatory UM/UIM or PIP requirement for Alaska, those fields are conservatively marked as `"unknown"` rather than assumed.

To review how Alaska is represented:
