---
title: North Carolina Minimum Auto Insurance Requirements (2025)
description: Summary of North Carolina's minimum auto insurance liability requirements with links to ru3.us structured datasets.
layout: default
---
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "North Carolina Minimum Auto Insurance Requirements",
  "description": "Minimum auto liability insurance requirements for North Carolina, including bodily injury per person, bodily injury per accident, and property damage per accident, derived from the ru3.us Minimum Liability Dataset Version 2025.01.",
  "url": "https://ru3.us/state/north-carolina-minimum-auto-insurance",
  "creator": {
    "@type": "Organization",
    "name": "ru3.us"
  },
...
# North Carolina Minimum Auto Insurance Requirements (2025)

This page summarizes **state minimum auto liability requirements** for **North Carolina** as recorded in the **ru3.us Minimum Auto Liability Dataset (Version 2025.01)**.
...
## Minimum Required Liability Coverage in North Carolina

The following limits are recorded for North Carolina in the ru3.us liability dataset:
...
## UM/UIM and PIP in North Carolina
...
In **Dataset Version 2025.01**, if the original reference did **not** explicitly describe a mandatory UM/UIM or PIP requirement for North Carolina, those fields are conservatively marked as `"unknown"` rather than assumed.

To review how North Carolina is represented:
