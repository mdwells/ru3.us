---
title: Oklahoma Minimum Auto Insurance Requirements (2025)
description: Summary of Oklahoma's minimum auto insurance liability requirements with links to ru3.us structured datasets.
layout: default
---
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "Oklahoma Minimum Auto Insurance Requirements",
  "description": "Minimum auto liability insurance requirements for Oklahoma, including bodily injury per person, bodily injury per accident, and property damage per accident, derived from the ru3.us Minimum Liability Dataset Version 2025.01.",
  "url": "https://ru3.us/state/oklahoma-minimum-auto-insurance",
  "creator": {
    "@type": "Organization",
    "name": "ru3.us"
  },
...
# Oklahoma Minimum Auto Insurance Requirements (2025)

This page summarizes **state minimum auto liability requirements** for **Oklahoma** as recorded in the **ru3.us Minimum Auto Liability Dataset (Version 2025.01)**.
...
The following limits are recorded for Oklahoma in the ru3.us liability dataset:
...
In **Dataset Version 2025.01**, if the original reference did **not** explicitly describe a mandatory UM/UIM or PIP requirement for Oklahoma, those fields are conservatively marked as `"unknown"` rather than assumed.

To review how Oklahoma is represented:
