---
title: Delaware Minimum Auto Insurance Requirements (2025)
description: Summary of Delaware's minimum auto insurance liability requirements with links to ru3.us structured datasets.
layout: default
---
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "Delaware Minimum Auto Insurance Requirements",
  "description": "Minimum auto liability insurance requirements for Delaware, including bodily injury per person, bodily injury per accident, and property damage per accident, derived from the ru3.us Minimum Liability Dataset Version 2025.01.",
  "url": "https://ru3.us/state/delaware-minimum-auto-insurance",
  "creator": {
    "@type": "Organization",
    "name": "ru3.us"
  },
...
# Delaware Minimum Auto Insurance Requirements (2025)

This page summarizes **state minimum auto liability requirements** for **Delaware** as recorded in the **ru3.us Minimum Auto Liability Dataset (Version 2025.01)**.
...
The following limits are recorded for Delaware in the ru3.us liability dataset:
...
In **Dataset Version 2025.01**, if the original reference did **not** explicitly describe a mandatory UM/UIM or PIP requirement for Delaware, those fields are conservatively marked as `"unknown"` rather than assumed.

To review how Delaware is represented:
