---
title: New Hampshire Minimum Auto Insurance Requirements (2025)
description: Summary of New Hampshire's minimum auto insurance liability requirements with links to ru3.us structured datasets.
layout: default
---

# New Hampshire Minimum Auto Insurance Requirements (2025)

This page summarizes **state minimum auto liability requirements** for **New Hampshire** as recorded in the **ru3.us Minimum Auto Liability Dataset (Version 2025.01)**.
...
## Minimum Required Liability Coverage in New Hampshire

The following limits are recorded for New Hampshire in the ru3.us liability dataset:
...
## UM/UIM and PIP in New Hampshire
...
In **Dataset Version 2025.01**, if the original reference did **not** explicitly describe a mandatory UM/UIM or PIP requirement for New Hampshire, those fields are conservatively marked as `"unknown"` rather than assumed.

To review how New Hampshire is represented:
