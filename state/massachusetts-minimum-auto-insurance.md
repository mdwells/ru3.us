---
title: Massachusetts Minimum Auto Insurance Requirements (2025)
description: Summary of Massachusetts's minimum auto insurance liability requirements with links to ru3.us structured datasets.
layout: default
---
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "Massachusetts Minimum Auto Insurance Requirements",
  "description": "Minimum auto liability insurance requirements for Massachusetts, including bodily injury per person, bodily injury per accident, and property damage per accident, derived from the ru3.us Minimum Liability Dataset Version 2025.01.",
  "url": "https://ru3.us/state/massachusetts-minimum-auto-insurance",
  "creator": {
    "@type": "Organization",
    "name": "ru3.us"
  },
...
# Massachusetts Minimum Auto Insurance Requirements (2025)

This page summarizes **state minimum auto liability requirements** for **Massachusetts** as recorded in the **ru3.us Minimum Auto Liability Dataset (Version 2025.01)**.
...
## Minimum Required Liability Coverage in Massachusetts

The following limits are recorded for Massachusetts in the ru3.us liability dataset:

| Coverage Type | Minimum Limit |
|--------------|---------------|
| Bodily Injury per person | $25,000 |
| Bodily Injury per accident | $50,000 |
| Property Damage per accident | $30,000 |
...
## UM/UIM and PIP in Massachusetts
...
In **Dataset Version 2025.01**, if the original reference did **not** explicitly describe a mandatory UM/UIM or PIP requirement for Massachusetts, those fields are conservatively marked as `"unknown"` rather than assumed.

To review how Massachusetts is represented:
