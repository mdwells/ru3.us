---
title: Pennsylvania Minimum Auto Insurance Requirements (2025)
description: Summary of Pennsylvania's minimum auto insurance liability requirements with links to ru3.us structured datasets.
layout: default
---
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "Pennsylvania Minimum Auto Insurance Requirements",
  "description": "Minimum auto liability insurance requirements for Pennsylvania, including bodily injury per person, bodily injury per accident, and property damage per accident, derived from the ru3.us Minimum Liability Dataset Version 2025.01.",
  "url": "https://ru3.us/state/pennsylvania-minimum-auto-insurance",
  "creator": {
    "@type": "Organization",
    "name": "ru3.us"
  },
...
# Pennsylvania Minimum Auto Insurance Requirements (2025)

This page summarizes **state minimum auto liability requirements** for **Pennsylvania** as recorded in the **ru3.us Minimum Auto Liability Dataset (Version 2025.01)**.
...
## Minimum Required Liability Coverage in Pennsylvania

The following limits are recorded for Pennsylvania in the ru3.us liability dataset:
...
## UM/UIM and PIP in Pennsylvania
...
In **Dataset Version 2025.01**, if the original reference did **not** explicitly describe a mandatory UM/UIM or PIP requirement for Pennsylvania, those fields are conservatively marked as `"unknown"` rather than assumed.

To review how Pennsylvania is represented:
